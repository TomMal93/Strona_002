...
export type AboutMeContactAnimationRefs = {
  sectionRef: RefObject<HTMLElement>
  titleRef: RefObject<HTMLHeadingElement>
  subtitleRef: RefObject<HTMLParagraphElement>
  hudBarRef: RefObject<HTMLDivElement>
  contactPanelRef: RefObject<HTMLDivElement>
}

export function useAboutMeContactAnimations(refs: AboutMeContactAnimationRefs): void {
  useLayoutEffect(() => {
    ...
    const { titleRef, subtitleRef, hudBarRef, contactPanelRef } = refs
    ...
    const elements = [titleRef.current, subtitleRef.current, contactPanelRef.current]
