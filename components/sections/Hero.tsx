    ...
    >
      ...
      <MobileHeroLayout>
        <HeroTextBlock
          ...
          textBlockClassName={styles.mobileTextBlockCentered}
          eyebrowClassName="block text-center font-bebas text-[34px] uppercase tracking-heading"
          subtitleClassName="mt-6 whitespace-pre-line pb-5 font-bebas text-[30px] leading-[1.5] tracking-heading"
          subtitleWrapClassName="w-full text-center"
          ctaClassName="px-4 py-2 text-center font-bebas text-[36px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-khaki focus-visible:outline-offset-2"
          socialIconClassName="inline-flex items-center justify-center [&>svg]:h-[32px] [&>svg]:w-[32px]"
          ctaContainerClassName="items-center"
          ctaButtonsRowClassName="justify-center"
          socialRowClassName="justify-center flex-wrap gap-4"
